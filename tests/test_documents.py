...
def test_pdf_preview_shows_beta_message(client, flask_app, login_as):
    login_as("alice")
    ...
    assert preview_response.status_code == 200
    assert b"Previews are currently unavailable for PDF documents." in preview_response.data
